...
BEGIN
    ...
    SET @sql = N'CREATE EXTERNAL TABLE [dbo].[O2Level_{Year}{Month}] WITH (
        LOCATION = ''O2Level/{Year}/{Month}/'',
...
FROM OPENROWSET
(
    BULK ''abfss://synapse@bdadatalake.dfs.core.windows.net/marsfarming_raw/O2Level/*.txt'',
    FORMAT = ''CSV'',
    PARSER_VERSION = ''2.0'',
    FIELDTERMINATOR = '';'',
    FIRSTROW = 1
