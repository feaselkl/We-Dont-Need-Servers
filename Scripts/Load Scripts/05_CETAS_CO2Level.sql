...
BEGIN
    ...
    SET @sql = N'CREATE EXTERNAL TABLE [dbo].[CO2Level_{Year}{Month}] WITH (
        LOCATION = ''CO2Level/{Year}/{Month}/'',
...
FROM OPENROWSET
(
    BULK ''abfss://synapse@bdadatalake.dfs.core.windows.net/marsfarming_raw/CO2Level/*.txt'',
    FORMAT = ''CSV'',
    PARSER_VERSION = ''2.0'',
    FIELDTERMINATOR = '';'',
    FIRSTROW = 1
