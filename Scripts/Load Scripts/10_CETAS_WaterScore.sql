...
BEGIN
    ...
    SET @sql = N'CREATE EXTERNAL TABLE [dbo].[WaterScore_{Year}{Month}] WITH (
        LOCATION = ''WaterScore/{Year}/{Month}/'',
...
FROM OPENROWSET
(
    BULK ''abfss://synapse@bdadatalake.dfs.core.windows.net/marsfarming_raw/WaterScore/*.txt'',
    FORMAT = ''CSV'',
    PARSER_VERSION = ''2.0'',
    FIELDTERMINATOR = '';'',
    FIRSTROW = 1
