...
BEGIN
    ...
    SET @sql = N'CREATE EXTERNAL TABLE [dbo].[Ph_{Year}{Month}] WITH (
        LOCATION = ''Ph/{Year}/{Month}/'',
...
FROM OPENROWSET
(
    BULK ''abfss://synapse@bdadatalake.dfs.core.windows.net/marsfarming_raw/Ph/*.txt'',
    FORMAT = ''CSV'',
    PARSER_VERSION = ''2.0'',
    FIELDTERMINATOR = '';'',
    FIRSTROW = 1
